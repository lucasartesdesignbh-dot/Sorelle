...
export const PromotionView: React.FC<PromotionViewProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="animate-fade-in">
      <section className="relative min-h-screen md:min-h-[85vh] flex items-center bg-sorelle-bg overflow-hidden pt-32 pb-12">
        ...
        <div className="container mx-auto px-6 relative z-10">
          {/* Botão VOLTAR PARA INÍCIO - Consistência e hitbox */}
            ...
            <div className="w-full lg:w-7/12 relative" id="selection">
              <div className="bg-white/50 backdrop-blur-sm p-4 md:p-6 rounded-3xl border border-white/60 shadow-xl">
                <div className="text-center mb-6 lg:mb-8">
                  <h3 className="font-serif text-2xl font-bold text-gray-800">Seu presente está a um clique</h3>
                  <p className="text-sm text-gray-500">Selecione a área que deseja ganhar:</p>
                </div>
      ...
      {showForm && (
        <section ref={formSectionRef} className="py-20 bg-sorelle-dark relative overflow-hidden">
          <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(#fff 1px, transparent 1px)', backgroundSize: '20px 20px' }} />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-sorelle-gold/30 blur-[100px] rounded-full pointer-events-none" />
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-center justify-center">
              <div className="text-white space-y-6 text-center md:text-left max-w-sm">
                 ...
                 <h2 className="font-serif text-3xl md:text-4xl font-bold leading-tight">Confirme seus dados</h2>
